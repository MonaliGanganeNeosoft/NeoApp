        ...
        <div className="ProductDetails" >
            ...
            <div>
                    ...
                    <div className='detailsBlock-3'>
                        <p>Price:<span style={{color:"green"}}>{`Rs${product.product_cost}`}</span></p>
                        {/* <p className="d-flex">Color:{`${product.color_code}`}</p> */}
                        
                        <p className="d-flex">Color :&nbsp;<input type="color" value={`${product.color_code}`} /></p>
                    ...
                    <p>
                    <Button variant="info" disabled={product.Stock < 1 ? true : false} onClick={addToCartHandler}   >Add to cart</Button>
                    <Button varinat="light" className="ms-2" onClick={submitReviewToggle} >Rate Product</Button>
