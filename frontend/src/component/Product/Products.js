...
const Products = ({match}) => {
   ...
   const [product_rating, setRating] = useState(0);
    ...
    useEffect(()=>{
        var allDetails=getProduct(keyword,currentPage,category_name,color_name,product_rating,sortBy,sortType)
        console.log(allDetails)
        
        dispatch(allDetails);

    },[dispatch,keyword,currentPage,category_name,color_name,product_rating,sortBy,sortType]);
    return (
        <>
        {loading?(
            <Loader/>
            ...
            <div className="productsHeading" style={{textAlign:"center",display:"flex",justifyContent:"flex-end",paddingRight:"150px",marginTop:"20px"}}>
          
                    <h6>Sort By: <img src='https://b.rgbimg.com/users/l/la/lajla/600/mybpemC.jpg' style={{height:"20px"}} onClick={(e)=>{
                      e.preventDefault();
                    ...
                    <h6>₹<a href='#' onClick={(e)=>{
                      ...
                      setSortBy(1)
                    }}>< BsArrowUp style={{ margin: '0 4 4 0', fontSize: 'larger' }} /></a></h6>
                    <h6>₹<a href='#' onClick={(e)=>{
                      e.preventDefault();
                      console.log("down btn clicked");
                      setSortBy(2)
                    }}>< BsArrowDown style={{ margin: '0 4 4 0', fontSize: 'larger' }} /></a></h6>
